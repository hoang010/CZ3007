...
%%
{WhiteSpace}+ {}
(\"\"\") {return new Token(STRING_LITERAL, yyline, yycolumn, "");}

/*Integer Literals*/
{Digits}+ {return token(INT_LITERAL, yytext());}

/*String Literals
Start with a ", followed by 0 or more non-quote char, ending with "
*/
...
/*Identifier*/
{Alpha}({Alpha}|{Digits}|"_")* {return token(ID, yytext());}
